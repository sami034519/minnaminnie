...
function Header() {
  ...
  return (
    <>
      {/* Fixed Top Marquee + Nav Container */}
            ...
            <div className="md:hidden bg-myPink text-white px-4 py-4 space-y-2 text-sm font-medium">
              ...
              {accessoriesOpen && (
                <div className="pl-4 space-y-1 flex flex-col gap-1">
                  <NavLink to="/accessories/fiddle" className={getActiveLink} onClick={closeMenus}>
                    Fiddle
                  </NavLink>
                  <NavLink to="/accessories/prams" className={getActiveLink} onClick={closeMenus}>
                    Prams
                  </NavLink>
                  <NavLink to="/accessories/walkers" className={getActiveLink} onClick={closeMenus}>
                    Walkers
                  </NavLink>
                </div>
              )}
              ...
              <div className="flex flex-col gap-2">
                <NavLink to="/toys" className={getActiveLink} onClick={closeMenus}>
                  Toys
                </NavLink>
                <NavLink to="/sport-wears" className={getActiveLink} onClick={closeMenus}>
                  Sport Wears
                </NavLink>
                <NavLink to="/baby-shoes" className={getActiveLink} onClick={closeMenus}>
                  Baby Shoes
                </NavLink>
              </div>
            </div>
